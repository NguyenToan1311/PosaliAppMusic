import 'package:appnghenhac/ui/new_login.dart';
import 'package:appnghenhac/ui/signup.dart';
import 'package:flutter/material.dart';

class posaliLoginScreen extends StatelessWidget {
  const posaliLoginScreen({super.key});
      ...
      body: SafeArea(
        child: Column(
          children: [
            ...
            Center(
              child: Image.asset(
                'assets/ITunes_12.2_logo.png', // Thay bằng logo của bạn
                width: 80,
                height: 80,
              ),
            ),
              ...
              child: Column(
                children: [
                  ...
                  _LoginButton(
                    ...
                    textColor: Colors.white,
                    iconAsset:
                        "assets/logofacebook.png", // Thay icon Facebook của bạn
